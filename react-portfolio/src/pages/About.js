...
function About() {
  return (
    <div style={{textAlign: 'center'}}>
      ...
      <div>
        <div>
          <img src="https://bloximages.newyork1.vip.townnews.com/richmond.com/content/tncms/assets/v3/editorial/5/d4/5d4995ed-536e-5d26-a8c1-bf47b0c71115/5b5e05d4f0df4.image.jpg?resize=1200%2C903" alt="Garrett Hudson" style={{height:'20rem', width: '25rem', marginTop: '5rem', marginBottom: '5rem', borderRadius: '5px',  boxShadow:         '3px 3px 5px 6px #ccc'}}>
          </img>
        </div>
